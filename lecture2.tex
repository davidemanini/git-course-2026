...
\begin{frame}{A typical collaborative workflow}
  \begin{enumerate}
  \item \texttt{git clone} the repository (using SSH, not HTTPS)
...
\begin{frame}{Exercise}
  \begin{enumerate}
    \item
    \begin{itemize}
    \item Setup SSH keys on a different computer
    \item Clone your repository on that computer
    \item Make some edits and push them
    \item Pull from a different computer
    \end{itemize}
  \item In pairs:
    \begin{itemize}
